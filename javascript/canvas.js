...
function enableAnnotations() {
    ...
    $("#articleHTML").mouseup(function (evt) {
        if (annotate_mode) {
            ...
            $("#annotation_" + annotation_number).append("<div class='text_button' style='display:none; position:relative; top: " + height + "px; width: " + width + "px;' id='text_field_" + annotation_number + "' note_id='" + annotation_number + "' ><textarea rows='1' cols='15'></textarea><input type='submit' value='submit' /></div>");
