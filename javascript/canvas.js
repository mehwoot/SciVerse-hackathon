...
function enableAnnotations() {
    ...
    $("#articleHTML").mouseup(function (evt) {
        if (annotate_mode) {
            ...
            $("#annotation_" + annotation_number).append("<div class='text_button' style='display:none; position:relative; top: " + height + "px; width: " + width + "px;' id='text_field_" + annotation_number + "' note_id='" + annotation_number + "' ><textarea id='textarea_" + annotation_number + "' rows='1' cols='15'></textarea><br/><input type='submit' note_id='" + annotation_number + "' id='annotation_submit_" + annotation_number + "' value='submit' /></div>");
            ...
            $("#annotation_submit_" + annotation_number).click(function () {
                alert($("#textarea_" + $(this).attr("note_id")).length);
                alert($(this).attr("note_id"));
                $("#text_field_" + $(this).attr("note_id")).before("<div style='position:relative; top:" + $(this).attr("top") + "px' >sdfsdfdsfsdfssdf" + $("#textarea_" + $(this).attr("note_id")).attr("value") + "</div>");
