    ...
    $("#articleHTML").mouseup(function (evt) {
        if (annotate_mode) {
            ...
            $("#annotation_submit_" + annotation_number).click(function () {
                $("#text_field_" + $(this).attr("note_id")).before("<div style='position:relative; top:" + $("#text_button_" + $(this).attr("note_id")).css("top") + "px' >" + $("#textarea_" + $(this).attr("note_id")).attr("value") + "</div>");
